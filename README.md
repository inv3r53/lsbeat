...
```
git remote set-url origin https://github.com/inv3r53/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/inv3r53
cd ${GOPATH}/github.com/inv3r53
git clone https://github.com/inv3r53/lsbeat
```
